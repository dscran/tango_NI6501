...
class NIUSB6501(Device):
    ...
    port3 = attribute(fget='read_port3',fset='write_port3',name='Port_1_3',access=AttrWriteType.READ_WRITE,dtype=bool)
    
    port4 = attribute(fget='read_port4',fset='write_port4',name='Port_1_4',access=AttrWriteType.READ_WRITE,dtype=bool)
    
    port5 = attribute(fget='read_port5',fset='write_port5',name='Port_1_5',access=AttrWriteType.READ_WRITE,dtype=bool)
    
    port6 = attribute(fget='read_port6',fset='write_port6',name='Port_1_6',access=AttrWriteType.READ_WRITE,dtype=bool)
    
    port7 = attribute(fget='read_port7',fset='write_port7',name='Port_1_7',access=AttrWriteType.READ_WRITE,dtype=bool)
    ...
    npulses = attribute(name='npulses', access=AttrWriteType.READ_WRITE,
